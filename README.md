...
`download/mangago_downloader` é mantido como um projeto independente e referenciado por este hub como submodule Git. O hub registra uma versão específica desse módulo sem misturar seu histórico interno.
